...
void soundEffect(){
    ...
    enemies[i].row, enemies[i].col, enemies[i].height, enemies[i].width)) {
        *(volatile u16*)0x04000078 = (((15) & 15) << 12) | 1 << 12 ;
        *(volatile u16*)0x0400007C = (1<<14) | 1 << 15 | drumR | drumS << 4 | 1 << 3;
        drumR = (drumR + 1) % 8;
        }
     }
    if ((!(~(oldButtons) & ((1<<5))) && (~buttons & ((1<<5)))) || (!(~(oldButtons) & ((1<<4))) && (~buttons & ((1<<4)))) || (!(~(oldButtons) & ((1<<6))) && (~buttons & ((1<<6)))) || (!(~(oldButtons) & ((1<<7))) && (~buttons & ((1<<7))))){
            if (song[note].note != REST) {
            *(volatile u16*)0x04000068 = (((15) & 15) << 12) | (0 << 11) | (((7) & 7) << 8) | (2 << 6);
            *(volatile u16*)0x0400006C = song[note].note | (1<<15) | (1<<14);
            }
            note++;
            if (note >= songLength) {
            note = 0;
    ...
    if ((!(~(oldButtons) & ((1<<0))) && (~buttons & ((1<<0))))){
            if (song[note].note != REST) {
                *(volatile u16*)0x04000062 = (((15) & 15) << 12) | (0 << 11) | (((7) & 7) << 8) | (2 << 6);
                *(volatile u16*)0x04000064 = song[note].note | (1<<15) | (1<<14);
...
void goToStart() {
    ...
    state = START;
    seed = 0;
    drawString((240 - (18 * 6)) / 2,0,"press SELECT to play", ((31) | (29)<<5 | (17)<<10));
    drawString((240 - (12 * 6)) / 2,100,"Run To A Game", ((31) | (29)<<5 | (17)<<10));
...
void gameState() {
    ...
    waitForVBlank();
    drawGame();
    drawString(10,140,"score:" ,((31) | (31)<<5 | (31)<<10));
    drawString(50,140,buffer,((31) | (31)<<5 | (31)<<10));
...
void goToPause() {
    ...
    state = PAUSE;
    drawString((240 - (5 * 6)) / 2,5,"Pause",((31) | (29)<<5 | (17)<<10));
...
void goToWin() {
    ...
    state = WIN;
    drawString((240 - (7 * 6)) / 2,5,"You win!",0);
...
void goToLose() {
    ...
    state = LOSE;
    drawString((240 - (7 * 6)) / 2,5,"You Lose!",((31) | (29)<<5 | (17)<<10));
    sprintf(buffer,"%u",score);
    drawString(50,140,buffer,((31) | (31)<<5 | (31)<<10));
 drawString(10,140,"score:" ,((31) | (31)<<5 | (31)<<10));
